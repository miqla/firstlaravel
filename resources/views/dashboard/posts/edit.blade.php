  ...
  <div class="col-lg-10">
      <form method="POST" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          {{-- laravel akan ngecek, ada old ga, klo gada tampilin isi dari post title --}}
        ...
        <div class="mb-3">
          ...
          {{-- ngirim gambar lama ke halaman update. klo ada gambar baru, gambar lama dihapus --}}
